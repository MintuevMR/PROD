...
import { getArticlesPageisLoading, getArticlesPageLHasMore, getArticlesPageNum } from '../selectors/articlesPageSelectors';
...
>(
    ...
    async (_, thunkApi) => {
        const hasMore = getArticlesPageLHasMore(thunkApi.getState());
